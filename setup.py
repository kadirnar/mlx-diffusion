...
def get_version():
    ...
    version_file = os.path.join(current_dir, 'mlx_diffusion', '__init__.py')
...
def get_author():
    current_dir = os.path.abspath(os.path.dirname(__file__))
    init_file = os.path.join(current_dir, 'mlx_diffusion', '__init__.py')
...
setuptools.setup(
    ...
    license=get_license(),
    description="Mlx-Diffusion",
    long_description=get_long_description(),
    long_description_content_type='text/markdown',
    url='https://github.com/kadirnar/mlx-diffusion',
